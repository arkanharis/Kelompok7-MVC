...
if (strlen($_SESSION['avmsaid'] == 0)) {
  ...
  include_once ('../controller/visitorpassController.php');
                ...
                <div class="col-lg-12">
                  <div class="card" id="divToPrint">
                    <div class="card-header">
                      <?php
                      $pid = $_GET['pid'];
                      $result = $visitorpassController->getVisitorPassById($pid);
                      $cnt = 1;
                      ...
                      <p style="text-align: center;font-size: 20px;color: red">
                        <input type="button" class="btn btn-primary" value="Print the Pass" onclick="PrintDiv();" />
                      </p>
                    </div>
