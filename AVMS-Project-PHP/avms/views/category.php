...
if (strlen($_SESSION['avmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $result = $categoryController->insertCat($catname);
        if ($result) {
    ...
    if (isset($_GET['catid'])) {
        ...
        $result = $categoryController->deleteCat($catid);
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <?php
                                        $result = $categoryController->getCatorder();
                                        $cnt = 1;
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="category.php?catid=<?php echo $row['id']; ?>"
