...
if (strlen($_SESSION['avmsaid'] == 0)) {
    ...
    if (isset($_POST['search'])) {
        ...
        $searchResult = $visitorController->searchVisitors($sdata);
    }
?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($row['WhomtoMeet']); ?></td>
                                                        <td><a href="visitor-detail.php?editid=<?php echo $row['ID']; ?>"><i class="fa fa-edit fa-1x"></i></a></td>
                                                    </tr>
                                                <?php
                                                    $cnt++;
                                                }
                                    ...
                                    <?php } else { ?>
                                        <p align="center">Please enter a search term above.</p>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
