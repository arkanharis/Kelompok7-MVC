...
include "../controller/departmentsController.php"; 
...
if(isset($_POST['submit']))
{
    ...
    $visitorController->addVis($fullname, $mobnumber, $email, $add, $whomtomeet, $department, $reasontomeet);
}

$departmentsController = new departmentsController();
$department = $departmentsController->getDeptorder();
