...
// Mengecek apakah ada session cvmsaid, jika tidak maka redirect ke logout.php
if (strlen($_SESSION['cvmsaid']) == 0) {
    ...
    if(isset($_POST['submit'])) {
        ...
        $result = $departmentsController->addDepartment($deptname);
        if ($result) {
    ...
    // Menghapus departemen jika ada parameter catid yang diterima melalui GET
    if(isset($_GET['catid'])) {
        $catid = intval($_GET['catid']);
        $result = $departmentsController->deleteDepartment($catid);
        if ($result) {
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive table--no-card m-b-30">
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = $departmentsController->getDeptorder();
                                        $cnt = 1;
                                        while ($row = $departmentsController->departmentsModel->fetch($query)) {
                                        ?>
                                        <tr>
                                            <td><?php echo $cnt;?></td>
